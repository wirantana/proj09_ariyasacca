...
var w=u(this);function x(a,b){if(b){for(var c=w,e=a.split("."),h=0;h<e.length-1;h++){var k=e[h];k in c||(c[k]={});c=c[k]}e=e[e.length-1];h=c[e];k=b(h);k!=h&&null!=k&&r(c,e,{configurable:!0,writable:!0,value:k})}}
